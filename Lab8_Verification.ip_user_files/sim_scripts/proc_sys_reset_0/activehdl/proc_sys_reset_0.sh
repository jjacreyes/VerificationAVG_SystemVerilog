...
#
# Script generated by Vivado on Tue Mar 10 11:43:18 -0400 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="W:/Desktop/SystemVerilogLabs/Lab8_Verification/Lab8_Verification.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
