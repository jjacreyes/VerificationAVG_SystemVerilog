...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Lab8_Verification.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Lab8_Verification.gen/sources_1/ip/clk_wiz_0" \
